...
function query_FId($FId)
{
	$ch = curl_init();
		$timeout = 3000;
		$url =  "oxfordhk.azure-api.net/academic/v1.0/evaluate?expr=Composite(F.FId=".$FId.")&count=10000&attributes=Id&subscription-key=f7cc29509a8443c5b3a5e56b0e38b5a6";
